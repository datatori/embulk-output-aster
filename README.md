# Aster output plugin for Embulk

Aster output plugin for Embulk loads records to a database using a Aster JDBC driver. If the database follows ANSI SQL standards and JDBC standards strictly, this plugin works. But because of many incompatibilities, use case of this plugin is very limited. It's recommended to use specific plugins for the databases.
...
- **url**: URL of the JDBC connection (e.g. 'jdbc:ncluster://127.0.0.1') (string, required)
